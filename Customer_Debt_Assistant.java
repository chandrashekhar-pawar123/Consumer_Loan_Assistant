...
public class Consumer_Loan_Assistant extends JFrame implements ActionListener {
    ...
    Consumer_Loan_Assistant() {
        ...
        tf1.setBounds(190, 30, 100, 20);
        tf1.setFont(arial);
        tf1.setHorizontalAlignment(JTextField.RIGHT);
        add(tf1);

        tf2.setBounds(190, 60, 100, 20);
        tf2.setHorizontalAlignment(JTextField.RIGHT);
        tf2.setFont(arial);
        add(tf2);

        tf3.setBounds(190, 98, 100, 20);
        tf3.setHorizontalAlignment(JTextField.RIGHT);
        tf3.setFont(arial);
        add(tf3);

        tf4.setBounds(190, 135, 100, 20);
        ...
        x1 = new JButton("X");
        x1.setBounds(300, 95, 50, 25);
        x1.setFont(fbutton);
        add(x1);

        x2 = new JButton("X");
        x2.setBounds(300, 133, 50, 25);
        x2.setFont(fbutton);
        add(x2);
        x2.setVisible(false);
        ...
        if (e.getSource() == b1) {
            try {
                ...
                if ((tf1.getText().equals("") || tf2.getText().equals("") || tf3.getText().equals(""))
                        && (tf1.getText().equals("") || tf2.getText().equals("") || tf4.getText().equals(""))) {
